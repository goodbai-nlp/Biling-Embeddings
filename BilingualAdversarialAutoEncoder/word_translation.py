...
DIC_EVAL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'bilingual_dicts')
...
def load_identical_char_dico(word2id1, word2id2):
    ...
    #print("all {} pairs".format(len(pairs)))
    return dico
...
def get_word_translation_accuracy(lang1, word2id1, emb1, lang2, word2id2, emb2, method, path):
    """
